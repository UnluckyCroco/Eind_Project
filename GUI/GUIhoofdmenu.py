...
regibutton = Button(master=hoofdmenu, text='Registreren',
                   bg='lightgreen', relief=SOLID, font='Calibri',
                   width=40)
regibutton.place(relx=0.5, rely=0.5, anchor=SE)

logingobutton = Button(master=hoofdmenu, text='Inloggen',
                   bg='lightgreen', relief=SOLID, font='Calibri',
                   width=40)
logingobutton.place(relx=0.5, rely=0.5, anchor=SW)

infobutton = Button(master=hoofdmenu, text='Informatie',
                   bg='lightgreen', relief=SOLID, font='Calibri',
                   width=40)
